...
upvalueScriptContext:SetCallback(function()
    ...
    local closureData = closure.Data
    local closureScript = getInstancePath(rawget(getfenv(closureData), "script"))

    local script = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/Upbolt/Hydroxide
...
local closure = aux.searchClosure(scriptPath, closureName, closureConstants)
local index = %s
